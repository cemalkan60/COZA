    ...
    >
      ...
      >
        ...
        <Pressable
          ...
          hitSlop={10}
          style={[styles.heart, { backgroundColor: colors.surface + "E6" }]}
        >
          <Feather
            name="heart"
            size={15}
            color={fav ? colors.brand : colors.onSurfaceTertiary}
            style={fav ? { opacity: 1 } : { opacity: 0.9 }}
          />
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  code: { marginTop: 2, letterSpacing: 0.5, fontWeight: "600" },
});
